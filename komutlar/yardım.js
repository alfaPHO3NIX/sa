...
Premium'unuzun olup olmadığını gösterir
  ...
  $onlyIf[$interactionData[values[0]]==help-1;]
  ;;;;yes]
  `
},{
name:"help",
...
$interactionReply[;{newEmbed:
 {title:Etkinlikler}
 {description:Etkinlik Seç};{actionRow:{selectMenu:helpCustomID:Etkinlik Seç:1:1:no:{selectMenuOptions:This won't show up:helpValue0:Either this.:false}{selectMenuOptions:This won't show up either.:helpValue1:cause menu disabled.:false}}}
 ;;;yes]
